...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                marks={0: '0 Kg',2500: '2500KG', 5000:'5000 Kg' ,
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        selected_data = spacex_df[spacex_df['Launch Site'] == entered_site]
        success_count = selected_data[selected_data['class'] == 1].shape[0]
        failure_count = selected_data[selected_data['class'] == 0].shape[0]
        fig = px.pie(values=[success_count, failure_count],
        names=['Success', 'Failure'],
        title=entered_site + ' Launches ')
        return fig
